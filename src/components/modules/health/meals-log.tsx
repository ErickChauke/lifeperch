...
// The dated meal log: a weekly calorie strip plus the selected day grouped by
// meal type. Lives inside the Health hub, so it owns no page chrome of its own.
export function MealsLog({ meals, today }: { meals: Meal[]; today: string }) {
    ...
    return (
      <>
        <MoneyEmpty
          ...
          message="No meals logged yet. Jot what you eat - breakfast, a snack, dinner - with a time and calories if you want them, and your week takes shape."
          action={
